...
int main() {
	...
	std::cout << "Max component of 200, 4, 34, 4: " << vx::Vec4(200, 4, 34, 4).MaxComponent() << "\n";
	...
	auto experiment_dot_simd = [](const vx::Vec4& v0, const vx::Vec4& v1) {
		...
		std::cout << "Vec 3 dp multiply [op first 3 & store 1 (first)]: " << vx::Vec4(_mm_dp_ps(v0.mValue, v1.mValue, 0x71));
		std::cout << "\n";
		std::cout << "Vec 4 dp multiply [op first 4 & store 1 (first)]: " << vx::Vec4(_mm_dp_ps(v0.mValue, v1.mValue, 0xf1));
		std::cout << "\n";
		std::cout << "Vec 3 dp multiply [op first 3 & store 3 (first)]: " << vx::Vec4(_mm_dp_ps(v0.mValue, v1.mValue, 0x77));
		std::cout << "\n";
		std::cout << "Vec 4 dp multiply [op first 4 & store 4 (first)]: " << vx::Vec4(_mm_dp_ps(v0.mValue, v1.mValue, 0xff));
		std::cout << "\n";
		std::cout << "Vec 3 dp multiply [op first 3 & store 4 (first)]: " << vx::Vec4(_mm_dp_ps(v0.mValue, v1.mValue, 0x7f));
		std::cout << "\n";
	...
	std::cout << "=========Invert===========\n";
	std::cout << "Inverted of " << t1 << ",(expected " << vx::Vec4(-t1.X(), -t1.Y(), -t1.Z(), -t1.W()) << "): " <<
		t1.Inverted() << "\n";

	std::cout << "=========Cross===========\n";
	vx::Vec4 t2(1.0f, 23, 12, 1.0f);
	std::cout << "Cross of " << t1 << "with " << t2 << ",(expected " << vx::Vec4::Cross3_NOT_SIMD(t1, t2) << "): " <<
		vx::Vec4::Cross3(t1, t2) << "\n";
