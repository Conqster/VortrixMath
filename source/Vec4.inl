...
inline FORCE_INLINE float Vec4::GetLane(const Vec4& v, int idx)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Zero()
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE void Vec4::ToZero()
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Broadcast(float scalar)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::LoadAligned(const float* v)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Load(const float* v)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE void Vec4::Store(float* o_v) const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::operator+(const Vec4& rhs) const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4& Vec4::operator+=(const Vec4& rhs)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::operator*(const float scalar) const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4& Vec4::operator*=(const float scalar)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Divide(const float scalar)
{
	Vec4 t = *this;
...
inline FORCE_INLINE float Vec4::MinComponent() const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE float Vec4::MaxComponent() const
{
#if USE_SIMD_SSE
	//__m128 shuf1 = _mm_shuffle_ps(value, value, _MM_SHUFFLE(2, 3, 0, 1)); // y z w x
...
inline FORCE_INLINE int Vec4::MaxAxis() const
{
	return (X() > Y()) ? ((X() > Z()) ? ((X() > W()) ? 0 : 3) : (Z() > W() ? 2 : 3)) : ((Y() > Z()) ? ((Y() > W()) ? 1 : 3) : (Z() > W() ? 2 : 3));
}

inline FORCE_INLINE int Vec4::MinAxis() const
{
	return (X() < Y()) ? ((X() < Z()) ? ((X() < W()) ? 0 : 3) : (Z() < W() ? 2 : 3)) : ((Y() < Z()) ? ((Y() < W()) ? 1 : 3) : (Z() < W() ? 2 : 3));
}

inline FORCE_INLINE Vec4 Vec4::Min(const Vec4& lhs, const Vec4& rhs)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Max(const Vec4& lhs, const Vec4& rhs)
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE float Vec4::Dot(const Vec4& rhs) const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE float Vec4::Dot(const Vec4& lhs, const Vec4& rhs)
{
#if USE_SIMD_SSE
	/// 0x71 -> 0111 0001 : op first 3 & store 1 (first)
	/// 0xf1 -> 1111 0001 : op first 4 & store 1 (first)
...
inline FORCE_INLINE float Vec4::LengthSq() const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE float Vec4::Length() const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4 Vec4::Normalised_NOT_SIMD() const
{
...
inline FORCE_INLINE Vec4 Vec4::Normalised() const
{
#if USE_SIMD_SSE
	/// 0x71 -> 0111 0001 : op first 3 & store 1 (first)
	/// 0xf1 -> 1111 0001 : op first 4 & store 1 (first)
...
inline FORCE_INLINE Vec4& Vec4::Normalise()
{
#if USE_SIMD_SSE
	/// 0x71 -> 0111 0001 : op first 3 & store 1 (first)
	/// 0xf1 -> 1111 0001 : op first 4 & store 1 (first)
...
inline FORCE_INLINE Vec4 Vec4::Inverted() const
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec4& Vec4::Invert()
{
#if USE_SIMD_SSE
...
inline FORCE_INLINE Vec3 Vec4::Cross3_NOT_SIMD(const Vec4& lhs, const Vec4& rhs)
{
	Vec3 temp = Vec3(0.0f);
...
inline FORCE_INLINE Vec3 Vec4::Cross3(const Vec4& lhs, const Vec4& rhs)
{
#if USE_SIMD_SSE
	/// y * z - z * y
	/// z * x - x * z
